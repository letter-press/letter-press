...
import { getPosts, createPage } from "../../../lib";
...
export default function AdminPages(): JSX.Element {
              ...
              <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="mt-4 sm:mt-0">
                  <form action={createNewPage} method="post">
                    ...
                    >
                      <Show
                        when={createPageAction.pending}
                        fallback={<span class="mr-2">➕</span>}
                      >
                        <div class="animate-spin rounded-full h-4 w-4 border-b-2 border-white mr-2"></div>
                      </Show>
                      {createPageAction.pending
                        ? "Creating..."
                        : "Create New Page"}
                    </button>
                  </form>
              ...
              <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  <select
                    ...
                    value={statusFilter()}
                    onChange={(e) => setStatusFilter(e.currentTarget.value as "all" | "published" | "draft" | "private")}
                  >
...
function PageStatsCard(props: PageStatsCardProps): JSX.Element {
  const colorClasses = {
